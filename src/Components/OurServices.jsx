    ...
    <div class="flex flex-wrap justify-center -mx-4">
      <div class="w-1/2 md:w-1/3 lg:w-1/5 px-4 mb-8 lg:mb-0">
        <div class="flex items-center justify-center hover:scale-110 transition duration-300 ease-in-out bg-white  rounded-lg shadow-slate-950 shadow-lg overflow-hidden">
          <img class="object-contain w-[260px] h-[260px] flex flex-row p-1" src="./Assets/money.png" alt=""/>
        </div>
      ...
      <div class="w-1/2 md:w-1/3 lg:w-1/5 px-4 mb-8 lg:mb-0">
        <div class="flex items-center justify-center hover:scale-110 transition duration-300 ease-in-out bg-white  rounded-lg shadow-slate-950 shadow-lg overflow-hidden">
          <img class="object-contain w-[260px] h-[260px] flex flex-row p-1" src="./Assets/hammer.png" alt=""/>
        </div>
      ...
      <div class="w-1/2 md:w-1/3 lg:w-1/5 px-4 mb-8 lg:mb-0">
        <div class="flex items-center justify-center hover:scale-110 transition duration-300 ease-in-out bg-white  rounded-lg shadow-slate-950 shadow-lg overflow-hidden">
          <img class="object-contain w-[260px] h-[260px] flex flex-row p-1" src="./Assets/Home.png" alt=""/>
        </div>
      ...
      <div class="w-1/2 md:w-1/3 lg:w-1/5 px-4 mb-8 md:mb-0">
        <div class="flex items-center justify-center hover:scale-110 transition duration-300 ease-in-out bg-white  rounded-lg shadow-slate-950 shadow-lg overflow-hidden">
          <img class="object-contain w-[260px] h-[260px] flex flex-row p-1" src="./Assets/services.png" alt=""/>
        </div>
      ...
      <div class="w-1/2 md:w-1/3 lg:w-1/5 px-4">
        <div class="flex items-center justify-center hover:scale-110 transition duration-300 ease-in-out bg-white  rounded-lg shadow-slate-950 shadow-lg overflow-hidden">
          <img class="object-contain w-[260px] h-[260px] flex flex-row p-1" src="./Assets/page.png" alt=""/>
        </div>
