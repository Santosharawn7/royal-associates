  ...
  return (
    ...
    <section class="relative md:py-36 font-serif overflow-hidden bg-gray-100">
      ...
      <div class="relative container px-4 mx-auto">
        <div class=" pt-24">
          <h1 class="font-heading text-4xl sm:text-6xl text-center  rounded-3xl p-4 text-yellow-900 lg:text-8xl xl:text-10xl font-bold mb-12">
            <span>Royal Associates </span>
          </h1>
          <h3 class="font-headingtext-3xl text-center rounded-3xl  text-yellow-500 lg:text-5xl xl:text-5xl font-bold mb-12">
